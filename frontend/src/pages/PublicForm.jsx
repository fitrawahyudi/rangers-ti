...
function PublicForm() {
  ...
  return (
    <>
      <title>Daftar - Rangers TI Batch 4</title>
      ...
      <div className="container-md my-5 p-4 p-md-5 border rounded shadow bg-white">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="alert alert-primary" role="alert">
            <strong>Info:</strong> Email dan password ini akan digunakan untuk
            login di halaman
            <Link to="/login" className="alert-link">
              {" "}
              Cek Status{" "}
            </Link>
            setelah mendaftar, untuk mendapatkan informasi tentang Status
            Pendaftaran
          </div>
          <div className="mb-3">
